...
1. Integration Tests: Validate interactions between components and backend.

1. End-to-End (E2E) Tests: Simulate user workflows like resizing grids, using brushes, and exporting files.
