...
│   │   │   └── index.js
│   │   └── index.js        # Main entry for all components
│   │
...
│   │   │   └── index.js
│   │   ├── fileHandlers.js
│   │   └── index.js        # Main export file for utils
│   │
│   ├── state/
│   │   ├── presets.js
│   │   └── useAnchorHistory.js
...
│   │   ├── styles.css
│   │   ├── index.js
│   │   ├── variables.css   # Color schemes, font sizes, etc.
│   │   ├── mixins.css      # Common CSS mixins
...
**NOTE:** *BELOW IS JUST AN EXAMPLE OF THE FUNCTION FOR YOUR UNDERSTANDING, THE CURRENT CODE IS MUCH MORE DEVELOPED AT THIS TIME.*
...
  const updatedColors = { ...cellColors };Object.keys(updatedColors).forEach((index) => {
